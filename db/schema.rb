...
ActiveRecord::Schema[7.0].define(version: 2024_12_22_132712) do
  create_table "articles", charset: "utf8mb3", force: :cascade do |t|
    t.string "title", null: false
    t.text "text", null: false
    t.integer "categorygenre", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "category_genres", charset: "utf8mb3", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
